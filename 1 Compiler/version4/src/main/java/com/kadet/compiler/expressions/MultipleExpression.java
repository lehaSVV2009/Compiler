 ...
 * @author Кадет
 */
public class MultipleExpression extends BinaryExpression {

    public MultipleExpression (Expression expression1, Expression expression2) {
    ...
    public Value calculate () throws KadetException {
        ...
        if (ValueUtils.isInteger(value1) && ValueUtils.isInteger(value2)) {
            return integerMultiplyInteger(value1, value2);
        }
        throw new KadetException("MULTIPLE Operation Error!");
    }

    private Value integerMultiplyInteger (Value value1, Value value2) {
